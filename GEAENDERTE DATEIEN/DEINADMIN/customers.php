 ...
 * @version $Id: customers.php for Zahlungsart nur fuer bestimmte Kunden anbieten 2023-11-13 12:15:51Z webchills $
 */
    ...
    switch ($action) {
      ...
      $entry_city = zen_db_prepare_input($_POST['entry_city']);
            ...
            if ($error === false) {
		     ...
		     [
                        'fieldName' => 'optional_payment_1',
                        'value' => $optional_payment_1,
                        'type' => 'stringIgnoreNull'
                    ],
